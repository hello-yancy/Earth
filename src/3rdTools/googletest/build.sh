...
SOURCE_CODE_PATH=${PROJECT_ROOT_PATH}/src/3rdTools/googletest
PACKED_SOURCE_CODE=googletest-release-1.8.1.zip
UNPACKED_SOURCE_CODE=googletest-release-1.8.1
